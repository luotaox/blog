<template>
    <article class="post post-list">
        <div class="post-entry">
            ...
            <div class="p-time">
                <i class="iconfont iconmeditor-time"></i> {{ initTime(post.pubTime) }}<i v-if="post.isHot"
            ...
            <footer class="entry-footer">
                <div class="post-more">
                    <div @click="upViewCount(post)">
                        <i class="iconfont iconfish-li" style="font-size: 25px;" @click="upViewCount"></i>
                    </div>
                </div>
                <div class="info-meta">
                    <div class="comnum">
