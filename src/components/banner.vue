            ...
            <template v-if="isHome">
                ...
                <div class="focusinfo">
                    ...
                    <div class="top-social">
                        <div v-for="item in socials" :key="item._id" :title="item.title"><a :href="item.href"
                                target="_blank" :style="{ 'color': item.color }"><i class="iconfont"
                                    :class="item.icon"></i></a></div>
                    </div>
                </div>
                <!--左右倾斜-->
...
export default {
    ...
    methods: {
        ...
        getImg() {
            axios.get('/webapi/site/img').then((res) => {
                this.src = res.data.data[0].img;
            })
        }
    },
    mounted() {
